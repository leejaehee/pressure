...
CREATE TABLE IF NOT EXISTS SH.SHEET (
  ...
  SET_PRESS         FLOAT(10, 5),
  BACK_PRESS        FLOAT(10, 5),
  COLD_PRESS        FLOAT(10, 5),
  RESULT_SET_PRESS  FLOAT(10, 5),
  RESULT_COLD_PRESS FLOAT(10, 5),
  RESULT_BACK_PRESS FLOAT(10, 5),
  RESULT_POP_PRESS  FLOAT(10, 5),
  RESULT_LEAK_PRESS FLOAT(10, 5),
  RESULT_OK         VARCHAR(255),
  ADJUST_SCREW      FLOAT(10, 5),
  UPPERING          BIGINT,
  LOWERING          BIGINT,
  WORKER            VARCHAR(255),
